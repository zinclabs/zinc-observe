...
#[openapi(
    paths(
        ...
        request::alerts::alert_deprecated::save_alert,
        request::alerts::alert_deprecated::update_alert,
        request::alerts::alert_deprecated::list_stream_alerts,
        request::alerts::alert_deprecated::list_alerts,
        request::alerts::alert_deprecated::get_alert,
        request::alerts::alert_deprecated::delete_alert,
        request::alerts::alert_deprecated::enable_alert,
        request::alerts::alert_deprecated::trigger_alert,
        request::alerts::alert_v2::create_alert,
        request::alerts::alert_v2::update_alert,
        request::alerts::alert_v2::list_alerts,
        request::alerts::alert_v2::get_alert,
        request::alerts::alert_v2::delete_alert,
        request::alerts::alert_v2::enable_alert,
        request::alerts::alert_v2::trigger_alert,
    ...
    components(
        schemas(
            ...
            crate::handler::http::models::alerts::SearchEventType,
            crate::handler::http::models::alerts::StreamType,

...
pub fn get_service_routes(cfg: &mut web::ServiceConfig) {
    ...
    cfg.service(
        web::scope("/api")
            ...
            .service(alerts::alert_deprecated::save_alert)
            .service(alerts::alert_deprecated::update_alert)
            .service(alerts::alert_deprecated::get_alert)
            .service(alerts::alert_deprecated::list_alerts)
            .service(alerts::alert_deprecated::list_stream_alerts)
            .service(alerts::alert_deprecated::delete_alert)
            .service(alerts::alert_deprecated::enable_alert)
            .service(alerts::alert_deprecated::trigger_alert)
            .service(alerts::alert_v2::create_alert)
            .service(alerts::alert_v2::update_alert)
            .service(alerts::alert_v2::get_alert)
            .service(alerts::alert_v2::list_alerts)
            .service(alerts::alert_v2::delete_alert)
            .service(alerts::alert_v2::enable_alert)
            .service(alerts::alert_v2::trigger_alert)

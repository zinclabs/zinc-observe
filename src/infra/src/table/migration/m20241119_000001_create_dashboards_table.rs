...
fn create_dashboards_table_statement() -> TableCreateStatement {
    Table::create()
        ...
        // Optional foreign key to the folders table. A null value indicates
        // that the dashboard is in the default folder.
        .col(ColumnDef::new(Dashboards::FolderId).big_integer().null())

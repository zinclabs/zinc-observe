...
use crate::{
    common::{
        ...
        meta::{self, ingestion::ORIGINAL_DATA_COL_NAME, stream::StreamParams},
        utils::functions,
    },
...
pub async fn search_multi(
    ...
    log::info!("alert multirange queries: {:#?}", queries);
    ...
    log::info!("multi_res after vrl: {:#?}", multi_res);

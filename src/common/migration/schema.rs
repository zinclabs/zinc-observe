...
/// This types and logic in this embedded module previously existed in other
/// parts of the codebase, such as service::db and config::meta. However the
/// types and logic in those module need to be able to change and evolve over
/// time, whereas the logic inside this migration needs be immutable to maintain
/// consistent behavior. Therefore logic in this module has been copied into
/// this migration script to preserve its original behvaior.
mod meta {

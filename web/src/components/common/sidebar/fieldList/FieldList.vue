...
<template>
  <div class="column field-menu">
    ...
    <div class="field-table q-mt-xs">
      <div
        data-test="log-search-field-list-fields-table"
      ...
      >
          ...
          <div class="field_list">
            ...
            >
              ...
              >
                <q-btn
                  :icon="outlinedAdd"
                  :data-test="`log-search-field-list-filter-${field.name}-field-btn`"
        ...
        <template>
          <q-input
            data-test="log-search-field-list-field-search-input"
            v-model="filterFieldValue"
            data-cy="field-field-search-input"
            filled
            borderless
            dense
            clearable
...
export default defineComponent({
  ...
  emits: ["event-emitted", "update:modelValue"],
  setup(props, { emit }) {
    const { fields, meta } = useFieldList();
